回答してみた。in 2016/02/11
一昨年の俺の回答を見てみたかったなあ。多分だいぶ変わってるから。
...
* 昨日・今週に何を学びましたか？
npmの自作モジュール。git_ignore_global。git rm -r --cached . nashorn（さわりだけ）,リーダブルコードの復習、vscodeのbuild、chromeのdevtoolやチャンネル、その他歴史など、symbol.for
